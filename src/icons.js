...
const Icons = (() => {
  ...
  const PATHS = {
    'camera':
      '<path d="M13.997 4a2 2 0 0 1 1.664.89l.812 1.22A2 2 0 0 0 18.137 7H19a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3v-8a3 3 0 0 1 3-3h.863a2 2 0 0 0 1.664-.89l.812-1.22A2 2 0 0 1 10.003 4z"/> <circle cx="12" cy="13" r="3"/>',
    'check':
