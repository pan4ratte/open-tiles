...
The start page can take video for its background, not only pictures. A file can be loaded from your computer, or given as a web address. Backgrounds can be dimmed or blurred to your taste, and the ones used last are kept in a history.
...
* The included wallpapers — [Unsplash](https://unsplash.com/license). Photographers: Adrien Olichon, Felix Besombes, Jason Mavrommatis, Julien Riedel, Milad Fakurian, Susk _i.
